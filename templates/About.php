...
<section>
    <div class="container  mx-auto">
        <h1
            class="uppercase text-[#05060F] text-[30px] md:text-[40px] font-bold tracking-[4.8px] mt-[10px] mb-[40px]">
...
?>
    <section class="container mx-auto mb-[35px] md:mb-[70px]">
        <div class="about_us">
            <div class="mb-[24px]">
                <h1
                    class="uppercase text-[#05060F] text-[20px] md:text-[32px] font-bold tracking-[3.8px] mb-[24px]">
            ...
            <div class="flex flex-col lg:flex-row gap-[20px]">
                ...
                <div class="imagesWrapper_ar lg:w-[412px] w-[100%]">
                    <img src="<?php echo $hero_section_image_1; ?>" class="w-[100%] h-[232px] object-cover rounded-[20px]" />
                    <img src="<?php echo $hero_section_image_2; ?>" class="w-[100%] h-[363px] mt-[20px] object-cover rounded-[20px]" />
                </div>
            </div>
        </div>
        <!-- stats Section start -->
        ...
        ?>
            ...
            <div class="flex flex-col md:flex-row items-center gap-[20px] mt-[20px]">
                ...
                ?>
                    <div
                        class="rounded-[20px] project bg-white py-[20px] md:py-[40px] px-[32px]">
                        <h1
                            class="uppercase text-center text-[#05060F] text-[16px] md:text-[24px] font-bold mb-[20px] roboto">
                            <?php echo $card_2_heading; ?>+
                        </h1>
                        <p
                            class="roboto text-center text-[14px] text-black tracking-[0.84px]">
    ...
    <section class="py-[40px] md:py-[70px]">
        <div class="container mx-auto">
            <div class="!w-[100%] md:!w-[458px] mb-[40px]">
                <h1
                    class="uppercase text-[24px] md:text-[32px] font-bold tracking-[3.6px] mt-[10px] mb-[24px]">
            ...
            ?>
                <div
                    class="allteam grid !grid-cols-1 lg:!grid-cols-4 gap-[20px] md:!grid-cols-2 rounded-[20px]">
                    ...
                    ?>
                        ...
                        <div class="team bg-white rounded-[20px]">
                            ...
                            <div class="location_text px-[32px] py-[40px]">
                                ...
                                <p
                                    class="roboto text-[14px] mb-[14px] text-black tracking-[0.84px]">
...
?>
    ...
    <section class="py-[40px] md:py-[70px]">
        <div class="container mx-auto">
            ...
            ?>
                <div
                    class="allpartners grid !grid-cols-2 lg:!grid-cols-4 gap-[20px] md:!grid-cols-2">
                    <?php foreach ($partners_images as $partner) {
                        $partner_image = $partner['partner_image'];
                    ?>

                        <div
                            class="partner bg-white rounded-[20px] p-[24px] h-[143px] flex items-center">
                            <img
                                src="<?php echo $partner_image; ?>"
                                class="m-auto w-[177px] h-[57px] object-contain" />
                        </div>
...
?>
    <section class="py-[40px] md:py-[70px]">
        <div class="container mx-auto">
            ...
            ?>
                <div
                    class="grid !grid-cols-1 lg:!grid-cols-4 gap-[20px] md:!grid-cols-2">
                    ...
                    ?>
                        ...
                        <div
                            class="bg-white rounded-[20px] p-[24px] h-[265px] flex flex-col justify-center items-center">
                            <img src="<?php echo $certifications_card_image; ?>" width="30" />
                            <h1
...
?>
    <section class="pt-[40px] md:pt-[70px] md:mb-[40px] mb-[20px]">
        <div class="container mx-auto">
            ...
            ?>
                <div
                    class="grid !grid-cols-1 lg:!grid-cols-3 gap-[20px] md:!grid-cols-2">
                    <?php
...
<?php } ?>
 <div id="popupOverlayapplynow" class="applynowform fixed inset-0 bg-black bg-opacity-60 flex justify-center items-center z-50 hidden h-fit">
  <div class="book_a_call flex flex-col w-[315px]  md:w-[884px] px-[20px] rounded-[20px] bg-white  relative">
    <img src="https://localdev.mi6.global/wp-content/uploads/2025/06/close.png"
         width="24" id="closePopup_apply"
         class="mt-[32px] ml-auto cursor-pointer" alt="Close">

    <h2 class="font-montserrat uppercase text-[20px] md:text-[32px] font-bold leading-[40px] tracking-[3.8px] md:mb-[24px]">
     Apply now
    </h2>
