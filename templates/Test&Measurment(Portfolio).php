...
<?php if ($overview_description): ?>
  <section class="pb-[50px] md:pb-[140px]">
    <div class="container mx-auto px-4">
      ...
      <div class="eqipmentall flex flex-col lg:flex-row items-center gap-[20px] lg:h-[346px]">
        ...
        ?>
        <div class="equipment py-[46px] px-[36px] bg-white rounded-[20px] w-[100%] lg:w-[33.33%] lg:h-full">
          <?php foreach ($feature as $featureone): ?>
            <div class="flex flex-col md:flex-row gap-[5px] md:gap-[70px]">
  ...
  <section class="pb-[50px] md:pb-[140px]">
    ...
    <div class="container mx-auto px-4">
      <div class="!w-[100%] md:!w-[572px] mb-[40px] ">
        <h1 class="font-montserrat uppercase text-[24px] md:text-[32px] font-bold tracking-[3.6px]  mb-[24px] md:leading-[40px]">
      ...
      <div class="usedall grid grid-col-1 lg:grid-cols-2 gap-[20px]">
        <?php foreach ($projects_project as $project):
          ...
          ?>
          <div class="used">
            <img src="<?php echo esc_url($project['image']['url']); ?>" class="h-[304px] rounded-t-[20px] w-full">
            <div
              ...
              <p class="roboto text-[14px] text-[#05060F] font-normal text-left text-black tracking-[0.84px] leading-[20px] md:h-[100px]">
        ...
        <?php foreach ($case_studies_all as $case):
          ...
          <div class="flex flex-col lg:flex-row rounded-[20px] gap-y-[20px]">
            <div class="apply bg-white py-[40px] px-[20px] md:px-[32px] rounded-l-[20px] w-[100%] lg:w-[50%]">
              ...
              <div class="applytext">
                <?php foreach ($caseinfo as $caseach): ?>
                  <div class="grid grid-cols-1 md:grid-cols-3 mb-[12px] gap-x-[10px]">

                    <p class="roboto text-[14px]  text-[#000000] font-normal  text-black tracking-[0.84px]">
                      <?php echo esc_html($caseach['heading']); ?>
                    </p>
                    <p class="roboto text-[14px] text-[#000000] font-normal  text-black tracking-[0.84px] col-span-2 leading-[20px]">
                      <?php echo $caseach['description']; ?>
                    </p>
                  </div>
                <?php endforeach ?>
            ...
            <img src="<?php echo esc_url($case['image']['url']); ?>"
              class=" w-[100%] lg:w-[50%] h-[unset] object-cover rounded-tr-[20px] object-cover">
          </div>
        <?php endforeach ?>
      </div>
