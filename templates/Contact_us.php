...
<section class="pb-[50px] md:pb-[70px]">
    <div class="container mx-auto px-4">
        <h1 class="uppercase text-[30px] md:text-[40px] font-bold tracking-[4.8px] mt-[10px] mb-[40px]">
            <?php echo esc_html($contact_page_heading); ?>
        </h1>
        <div class="contact_us">
            <div class="form_text mb-[40px]">
                <h2 class="uppercase text-[20px] md:text-[32px] font-bold leading-[40px] tracking-[3.8px] mb-[24px]">
    ...
    <?php echo do_shortcode('[wpforms id="869"]'); ?>
                ...
                <?php if (!empty($contact_image['url'])) : ?>
                    <img src="<?php echo esc_url($contact_image['url']); ?>" class="cover w-full lg:w-[63%]" alt="Contact Image" />
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<section class="pb-[50px] md:pb-[70px]">
    <div class="container mx-auto px-4">
        <div class="locations_text w-full md:w-[458px] mb-[40px]">
            <h2 class="uppercase text-[24px] md:text-[32px] font-bold tracking-[3.6px] mt-[10px] mb-[27px]">
            ...
            <?php foreach ($locations as $location): ?>
                <div class="location bg-white rounded-[20px]">
                    <div class="location_text px-[32px] py-[40px]">
                        <h3 class="uppercase roboto text-[20px] md:text-[24px] font-bold tracking-[1.2px] mt-[10px] mb-[20px]">
    ...
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-[22px]">
            <div class="email_text w-full lg:w-[37%]">
                <h2 class="uppercase text-[#05060F] text-[22px] md:text-[32px] font-bold tracking-[3.6px] mt-[10px] mb-[24px] leading-[24px] md:leading-[40px]">
                    <?php echo esc_html($Phone_and_Email_heading); ?>
                </h2>
                <p class="roboto mb-[40px] text-[14px] text-black tracking-[0.84px]">
                ...
                <div class="flex flex-col gap-[16px]">
                    <?php foreach ($Phone_and_Email_info as $info): ?>
                        <div class="email_link flex items-center gap-[12px]">
                            <img src="<?php echo esc_url(wp_get_attachment_image_url($info['icon'], 'full')); ?>" width="24" alt="Icon">
            ...
            <div class="images flex w-full lg:w-[63%] gap-2 md:gap-4">
                <img src="<?php echo esc_url($image_url1); ?>" class="object-cover rounded-[20px] w-[50%]" alt="Image 1" />
                <img src="<?php echo esc_url($image_url2); ?>" class="object-cover rounded-[20px] w-[50%]" alt="Image 2" />
            </div>
        </div>
    </div>
</section>
...
<section class="pb-[50px] md:pb-[70px]">
    <div class="container mx-auto px-4">
        <div class="flex flex-col lg:flex-row items-center gap-[22px]">
            ...
            <div class="images flex w-full lg:w-[63%] gap-2 md:gap-4">
                <img src="<?php echo $Social_media_image1; ?>" class="object-cover rounded-[20px] w-[50%]" alt="Social Image 1" />
                <img src="<?php echo $Social_media_image2; ?>" class="object-cover rounded-[20px] w-[50%]" alt="Social Image 2" />
            </div>
        </div>
    </div>
</section>
