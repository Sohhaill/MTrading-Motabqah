...
if (get_field('telecommunication_services_title')) :?>
    <div class="w-full justify-center flex pt-4 bg-[#f9f9f9]">
      ...
      <div class="flex flex-row gap-8 container mx-auto px-4 items-center">
 ...
 <?php if (get_field('telecom_services_section')) :?>
    <section class="pt-[40px] md:pb-[70px]">
      ...
      ?>
          ...
          <p
            class="roboto text-[#05060F] text-[14px] text-black tracking-[0.84px]"
          >
        ...
        <div class="usedall grid grid-col-1 lg:grid-cols-3 gap-[20px]">
          ...
          <div class="used">
            <img
              src="<?php echo esc_url($cards['telecom_services_card_image']['url']); ?>"
              height="158"
            ...
            >
              ...
              <p
                class="custom-ul-ol roboto text-[14px] text-[#05060F] font-normal text-left text-black tracking-[0.84px] w-full"
              >
    ...
    <section class="pb-[50px] pt-[70px] md:pb-[70px]">
      ...
      <div class="container mx-auto px-4">
        ...
        <div class="usedall grid grid-col-1 lg:grid-cols-2 gap-[20px]">
          ...
          <div class="used">
            <img
              src="<?php echo esc_url($projectcards['key_projects_handled_card_image']['url']); ?>"
              height="356"
              class="rounded-t-[20px] w-full"
            />
            <div
            ...
            >
              ...
              <p
                class="roboto text-[14px] text-[#05060F] font-normal text-left text-black tracking-[0.84px]"
              >
 ...
 <?php foreach($successful_installations_discription as $description):?>
            <p
              class="roboto text-[14px] text-[#05060F] font-normal text-left text-black tracking-[0.84px] w-full"
            >
          ...
          <div
            class="relative w-full md:w-[54.24%] rounded-[20px] aspect-video"
          >
            <img
              src="<?php echo esc_url($successful_installations_image['url']); ?>"
              alt="Team Working"
            ...
            <div
              class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 md:-left-10 md:translate-x-0 z-10"
            >
              <button
                id="video-play-button"
                data-video-url="<?php $successful_installations_discription_button['url']?>"
        ...
        <div class="Successful_installations gallery_imgrid grid md:grid-cols-4 gap-5 griddd pt-[20px]">
          ...
          <img src="<?php echo esc_url($gallery_image['image']['url']); ?>" class="h-[268px]" />
             <?php endforeach?>
        </div>
      </div>
    </section>
